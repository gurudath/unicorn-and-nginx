#define NGX_CONFIGURE " --prefix=/home/gurudath/RubymineProjects/unicorn-and-nginx/nginc_repository/nginx --add-module=../ngx_devel_kit-0.2.19 --add-module=../echo-nginx-module-0.51 --add-module=../xss-nginx-module-0.04 --add-module=../ngx_coolkit-0.2rc1 --add-module=../set-misc-nginx-module-0.24 --add-module=../form-input-nginx-module-0.07 --add-module=../encrypted-session-nginx-module-0.03 --add-module=../srcache-nginx-module-0.25 --add-module=../ngx_lua-0.9.4 --add-module=../headers-more-nginx-module-0.25 --add-module=../array-var-nginx-module-0.03 --add-module=../memc-nginx-module-0.14 --add-module=../redis2-nginx-module-0.10 --add-module=../redis-nginx-module-0.3.7 --add-module=../auth-request-nginx-module-0.2 --add-module=../rds-json-nginx-module-0.13 --add-module=../rds-csv-nginx-module-0.05 --with-ld-opt=-Wl,-rpath,/home/gurudath/RubymineProjects/unicorn-and-nginx/nginc_repository/luajit/lib --add-module=/home/gurudath/RubymineProjects/unicorn-and-nginx/nginc_repository/ngx_cache_purge-1.6 --with-http_image_filter_module --add-module=/home/gurudath/RubymineProjects/unicorn-and-nginx/nginc_repository/ngx_http_geoip2_module --with-http_spdy_module --with-ipv6 --with-http_geoip_module --with-http_ssl_module"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/gurudath/RubymineProjects/unicorn-and-nginx/nginc_repository/nginx/"
#endif
